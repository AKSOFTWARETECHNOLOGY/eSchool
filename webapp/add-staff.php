							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<select name="jobtype" class="form-control">
										<option value="opt1">Teaching Staff</option>
										<option value="opt2">Non Teaching Staff</option>
										<option value="opt3">Office Clerk</option>
									</select>
								</div>
							</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select name="jobposition" class="form-control">
                                        <option value="opt1">Principal</option>
                                        <option value="opt2">Junior Staff</option>
                                        <option value="opt3">Senior Staff</option>
                                    </select>
                                </div>
                            </div>
