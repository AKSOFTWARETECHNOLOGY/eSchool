...
$school_sq1 = "INSERT INTO `school_info` (user_id, name_school, name_person, address, city, state, country, pincode, telephone, mobile, email, website, school_code, created_by, updated_by, created_at, updated_at)
VALUES ('$last_id','$schoolName','$personName','$address','$cityId','$state','$countryId','$pincode','$telephone','$mobile','$email','$website','$schoolcode','$username','$username','$date','$date')";
